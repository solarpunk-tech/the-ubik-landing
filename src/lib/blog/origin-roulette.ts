...
export const originProfiles: OriginProfile[] = [
  {
    ...
    details:
      "Ecuador remains the structural volume leader in raw vannamei. The risk is not supply; it is oversupply spilling from China into U.S. and EU lanes, with spot prices softening when inventories rise.",
  ...
  },
  {
    ...
    stamp: "IND / 18%",
    stat: "₹72,325.82 crore FY26 seafood exports",
...
export const tariffCells: TariffCell[] = [
  { origin: "Ecuador", destination: "U.S.", effective: 12, pending: true, note: "CVD review pending" },
  ...
  { origin: "India", destination: "U.S.", effective: 18, note: "post-Feb 2026 reset" },
  ...
  { origin: "Vietnam", destination: "U.S.", effective: 12, pending: true, note: "IEEPA/origin audit risk" },
  { origin: "Vietnam", destination: "EU", effective: 5.5, note: "IUU yellow card" },
  { origin: "Vietnam", destination: "Japan", effective: 3.5 },
  { origin: "Vietnam", destination: "GCC", effective: 5 },
  { origin: "Indonesia", destination: "U.S.", effective: 4.5, pending: true, note: "ADD + FDA cert risk" },
  ...
  { origin: "Thailand", destination: "U.S.", effective: 3.5, pending: true, note: "IEEPA suspension risk" },
  { origin: "Thailand", destination: "EU", effective: 5.5, note: "FLR readiness" },
  { origin: "Thailand", destination: "Japan", effective: 3.5 },
  { origin: "Thailand", destination: "GCC", effective: 5 },
  { origin: "China", destination: "U.S.", effective: 137, note: "effectively blocked" },
  ...
  { origin: "Saudi Arabia", destination: "U.S.", effective: 0, note: "negligible volumes" },
  ...
  { origin: "Bangladesh", destination: "U.S.", effective: 0 },
  { origin: "Bangladesh", destination: "EU", effective: 0, pending: true, note: "LDC graduation watch" },
