...
export const bottomCallouts = [
  {
    title: "Agentify backend operations"
  },
  {
...
export const faqs: Faq[] = [
  {
    ...
    bullets: [
      ...
      "Tracking transit.",
      "Monitoring margin.",
      "Tracing lots from container to customer."
    ]
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "Most customers see measurable outcomes within 4 weeks.",
      "Onboarding runs week 1 mapping your value chain, week 2 building your first agent playbooks, week 3 driving operator adoption, week 4 delivering measurable results: time saved, margin recovered, decisions taken faster.",
      "If you do not see ROI in 90 days, we work for free until you do."
    ],
    bullets: [
      "One customer found $200K in recovered margin on a single account in month one.",
      "Another went from manual PO processing to 30-second extraction with ERP push.",
      "A third surfaced lot traceability from container to retailer in under 3 minutes."
    ]
  },
  {
  ...
  },
  {
    ...
    bullets: [
      ...
      "Data residency is available in the US, EU, and APAC.",
      "LLM models are called only for planning and action steps, never for training.",
      "Role-based permissions, SSO with Okta, Azure AD, and Google Workspace, and audit logging on every action are standard."
    ]
  },
  {
  ...
  },
  {
    ...
    bullets: [
      ...
      "Logistics and pricing intelligence: SeaRates, Expana, Maersk, custom carrier portals.",
      "Productivity: Google Drive, OneDrive, Dropbox, Notion."
    ]
  },
  {
    ...
    paragraphs: ["Ubik runs five workflow primitives in production."],
    bullets: [
      "RFQ to quote: assembles inventory, COGS, past quotes, and margin targets, then drafts a quote with human approval, compressing 5-7 day cycles to 6 hours.",
      "PO ingestion: extracts line items from PDF emails, maps to internal SKUs, pushes to ERP, and sends confirmation in a 30-second cycle.",
      "Transit-aware scheduling: when India to NJ shifts from 34 to 52 days, all downstream timelines auto-recalculate.",
      "VMI pull-rate dashboard: 90-day vs 120-day actuals and pricing-formula validation.",
      "Lot traceability: container number to retailer in under 3 minutes."
    ]
  },
  {
