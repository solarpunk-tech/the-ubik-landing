...
This workflow starts when a buyer asks for availability, pricing, quote readiness, partial shipment, substitution, or the next shipment window. The reply must protect margin, promise dates, account terms, and source traceability.
